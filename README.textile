...
The goal of this project is to create a site template that can be easily customized and used for 
blogs and websites with as much of the boring manual work removed.
